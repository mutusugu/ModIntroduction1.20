...
public class IntroductionmodItems {
    // レジストリの作成
    ...
    public static final RegistryObject<Item> ORHALCON_INGOT = ITEMS.register("orihalcon_ingot", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> OSUMIUMU = ITEMS.register("osumiumu", () -> new Item(new Item.Properties()));
